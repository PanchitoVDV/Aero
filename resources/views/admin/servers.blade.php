        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        <a href="{{ route('admin.servers.show', $server) }}" class="text-sm font-medium text-brand-600 hover:underline">{{ $server->name }}</a>
                    </td>
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('admin.servers.show', $server) }}" class="inline-flex items-center gap-1 text-sm font-medium text-brand-600 hover:text-brand-800 transition">
